...
var range=(Math.random() * 10000)+2000;
	...
	if (typeof (data[i]['georss:point']) != "undefined") {
		...
		console.log(data[i]['georss:point'][0].content);
		} else {
			console.log(data[i]['georss:point'].content);
		}
		console.log("\n");
	}
	}
	...
	var gps = require('gps2zip');
	 ...
	 console.log(gps.gps2zip(latitude, longitude)); // returns 78701
  ...
  // $scope.bla="dadas";
	...
	//$window.alert($scope.bla);


 	}]);

})();
},{"gps2zip":3}],3:[function(require,module,exports){
(function (__dirname){
...
}).call(this,"/node_modules\\gps2zip")
},{"fs":1,"kdt":4}],4:[function(require,module,exports){
/**
